<?php  
	...
	if(isset($_POST['game'])){
		...
		foreach($game_query as $row){
			...
			if($homepts > $awaypts){
				$output = $output."".$awaypts."</div><div class = 'col-sm-6'><b>".$homepts."</b></div></div>";
			}else{
				$output = $output."<b>".$awaypts."</b></div><div class = 'col-sm-6'>".$homepts."</div></div>";
			}

			$output = $output."<div class ='row text-center team-font'> @ </div> <div class = 'row text-center team-font'>
										<div class = 'col-sm-6'>
											Team ".$away."</div>
										<div class = 'col-sm-6'>Team ".$home."</div></div>
										<div class ='row roster-bar'>Team ".$away."</div>";
			...
			$output = $output." ".$away_roster_html."<div class ='row roster-bar'>Team ".$home."</div>";
			...
			$output = $output." ".$home_roster_html;
