<!-- Individual stats page - a redirect from viewer clicking on a player's name - includes season averages, game logs, and potentially past seasons info -->
<?php
...
<html lang="en">
	...
	<body id="player_body">
		...
		<!-- Per game stats -->
		<div class="container-fluid table-responsive" id = "ps_pergame" style = "display:show">
